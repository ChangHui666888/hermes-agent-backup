...
§
视频剪辑点工具: workspace\scene-splitter (PySceneDetect 0.7.1 + FastAPI + 独立 .venv, 端口8765, start.bat 启动)。bundle(8777) 已加 /splitter 反代 + iframe 卡片共用同一前端。默认素材目录 D:\Douyin\MV\待分段\douyin_阿木（山野），产物输出到 <视频名>_clips。