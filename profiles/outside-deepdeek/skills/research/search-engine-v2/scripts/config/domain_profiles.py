...
KNOWN_PROFILES: dict[str, DomainProfile] = {
    ...
    "wsj.com": DomainProfile(
        ...
        strategy_order=["archive", "search_snippet"],
        known_failing=["direct", "google_cache", "scrapling", "browser"],
        notes="DataDome全站防护。direct→403, google_cache→429, scrapling/browser→必败。仅archive偶尔可达；其余靠SearXNG/Tavily恢复",
    ),
    "bloomberg.com": DomainProfile(
        ...
        strategy_order=["archive", "search_snippet"],
        known_failing=["direct", "google_cache", "scrapling", "browser"],
        notes="DataDome全站防护。direct→403, google_cache→429, archive→偶可。浏览器可访问但headless被检测。靠SearXNG替代源恢复",
    ),
